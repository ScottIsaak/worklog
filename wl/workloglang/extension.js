	...
	var completionItemProvider = vscode.languages.registerCompletionItemProvider('worklog', {
		provideCompletionItems(document, position, token, context) {
			return [
				...
				new vscode.CompletionItem({ "label": 'TIME-3', "description": 'TIME-3 (Internal Service)->TIME-29' }, vscode.CompletionItemKind.Text),
				new vscode.CompletionItem({ "label": 'TIME-8', "description": 'TIME-8 (Meetings / Discussions)->TIME-30' }, vscode.CompletionItemKind.Text),
				new vscode.CompletionItem({ "label": 'TIME-7', "description": 'TIME-7 (Daily Stand-Up/Scrum)->TIME-31' }, vscode.CompletionItemKind.Text),
				new vscode.CompletionItem({ "label": 'TIME-6', "description": 'TIME-6 (Time Entry)->TIME-32' }, vscode.CompletionItemKind.Text),
				new vscode.CompletionItem({ "label": 'TIME-5', "description": 'TIME-5 (Agile Planning + Grooming)->TIME-33' }, vscode.CompletionItemKind.Text),
				new vscode.CompletionItem({ "label": 'TIME-19', "description": 'TIME-19 (Responding to Email)->TIME-34' }, vscode.CompletionItemKind.Text),
